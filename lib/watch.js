...
var Watch = (function (_super) {
    ...
    Watch.prototype.compileTask = function (file, reload) {
        ...
        var command = fileObject.command, relativeFile = fileObject.relativeFile, stdout = fileObject.stdout, stderr = fileObject.stderr;
        ...
        var checkBehavior = function (rules, content) {
            var ret = false;
